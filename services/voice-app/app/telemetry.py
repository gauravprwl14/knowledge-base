...
def configure_telemetry(service_name: str) -> None:
    """Configure OTel SDK with OTLP gRPC export and FastAPI auto-instrumentation.

    Must be called before FastAPI app creation and any route imports.
...
tracer = trace.get_tracer("voice-app")
